...
-- Raw businesses table (scraped but not verified)
...
-- Verified businesses table (after quality control)
...
-- Enable Row Level Security (RLS) for public read access (optional)
ALTER TABLE verified_businesses ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow public read access to verified businesses" ON verified_businesses
